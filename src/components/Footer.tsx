...
export const Footer: React.FC<FooterProps> = ({ onOpenUnlockModal, isAdmin, storeSettings = DEFAULT_STORE_SETTINGS }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 border-b border-zinc-800/80">
          ...
          <div className="space-y-3">
            ...
            {isAdmin && onOpenUnlockModal && (
              <div className="pt-2">
                <button
                  onClick={onOpenUnlockModal}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-pink-600 to-amber-600 text-white border border-pink-500/40 rounded-xl text-[11px] font-bold transition-all shadow-md cursor-pointer"
                >
