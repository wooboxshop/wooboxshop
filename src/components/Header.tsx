        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3">
          <div className="flex items-center justify-between gap-3 sm:gap-6">
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              ...
              {/* Admin Toggle - ONLY visible when admin mode is active! */}
              {isAdmin && (
                <button
                  onClick={onOpenAdmin}
                  className="px-3 py-1.5 bg-gradient-to-r from-pink-600 to-amber-600 text-white font-bold text-xs rounded-xl shadow-lg border border-pink-500/40 flex items-center gap-1.5 transition-transform active:scale-95 cursor-pointer"
                >
        ...
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          <div className="relative w-4/5 max-w-sm bg-[#09090e] border-r border-zinc-800 h-full overflow-y-auto p-5 flex flex-col justify-between shadow-2xl z-10 animate-in slide-in-from-left duration-200">
            <div className="space-y-6">
              ...
              {/* Admin Panel Action (if unlocked) */}
              {isAdmin && (
                <div className="pt-2 border-t border-zinc-800/80">
                  <button
                    ...
                    className="w-full p-3 bg-gradient-to-r from-pink-600 to-amber-600 text-white font-extrabold text-xs rounded-2xl shadow-lg border border-pink-500/40 flex items-center justify-between cursor-pointer"
                  >
